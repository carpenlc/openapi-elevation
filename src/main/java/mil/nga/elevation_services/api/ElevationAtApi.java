...
public interface ElevationAtApi {
    ...
    /**
     * GET /ElevationAt : Determine the elevation height value at a particular geographic location
     *
     * @param pts Comma seperated list of geographic points in lon, lat order.  The coordinates can be specified in either DMS format or decimal degrees. (required)
    ...
    /**
     * POST /ElevationAt : Determine the elevation height value at a particular geographic location
     *
     * @param elevationQuery Client specified geographic point.  The coordinates can be specified in either DMS format or decimal degrees. (required)
     * @return Elevation data requested. (status code 200)
     *         or unexpected error (status code 200)
     */
