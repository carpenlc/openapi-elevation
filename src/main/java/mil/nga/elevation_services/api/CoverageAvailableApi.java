...
public interface CoverageAvailableApi {
    ...
    /**
     * GET /CoverageAvailable : End point used to determine what coverage types are available for a given point.
     *
     * @param lat Latitude value of a coordinate pair.  The coordinates can be specified in either DMS format or decimal degrees. (required)
     * @param lon Longitude value of a coordinate pair.  The coordinates can be specified in either DMS format or decimal degrees. (required)
     * @return Simple text based response. (status code 200)
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"coordinate\" : { \"lon\" : \"lon\", \"lat\" : \"lat\" }, \"coverages\" : [ \"coverages\", \"coverages\" ] }";
    ...
    /**
     * POST /CoverageAvailable : End point used to determine what coverage types are available for a given point.  The post version allows clients to specify more than one pont of interest.
     *
     * @param coordinateTypeArray Client specified list of geographic points.  The coordinates can be specified in either DMS format or decimal degrees. (required)
     * @return Simple text based response. (status code 200)
     *         or unexpected error (status code 200)
     */
    ...
    default ResponseEntity<Object> getCoverageAvailablePOST(@ApiParam(value = "Client specified list of geographic points.  The coordinates can be specified in either DMS format or decimal degrees." ,required=true )  @Valid @RequestBody CoordinateTypeArray coordinateTypeArray) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"coveragesAvailable\" : [ { \"coordinate\" : { \"lon\" : \"lon\", \"lat\" : \"lat\" }, \"coverages\" : [ \"coverages\", \"coverages\" ] }, { \"coordinate\" : { \"lon\" : \"lon\", \"lat\" : \"lat\" }, \"coverages\" : [ \"coverages\", \"coverages\" ] } ] }";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
            }
