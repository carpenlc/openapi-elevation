...
public interface MinMaxElevationApi {
    ...
    /**
     * GET /MinMaxElevation : Determine the minium and maximum elevation height values within a particular bounding box.
     *
     * @param lllon The lower-left longitude coordinate of a bounding box.   The coordinates can be specified in either DMS format or decimal degrees. (required)
     * @param lllat The lower-left latitude coordinate of a bounding box.   The coordinates can be specified in either DMS format or decimal degrees. (required)
     * @param urlon The upper-right longitude coordinate of a bounding box.   The coordinates can be specified in either DMS format or decimal degrees. (required)
     * @param urlat The upper-right latitude coordinate of a bounding box.   The coordinates can be specified in either DMS format or decimal degrees. (required)
     ...
     * @return The minimum and maximum elevation values within the user-specified bounding box. (status code 200)
    ...
    /**
     * POST /MinMaxElevation : Determine the minium and maximum elevation height values within a particular bounding box.
     *
     * @param minMaxElevationQuery Client specified bounding box.  The coordinates can be specified in either DMS format or decimal degrees. (required)
     * @return Elevation data requested. (status code 200)
     *         or unexpected error (status code 200)
     */
